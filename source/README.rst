...
所以我就开始一字一句地全文翻译了一遍。在这个过程中，我得以反复和自己的架构设计
工作实践进行了数年的对比和校验，反复把这些方法用在我的架构设计和控制的工程实践
中。通过这个过程，我才意识到，原来《道德经》是个非常严密的论证过程。它基本上把“
抽象”是怎么回事，在现实中应该怎么应用它，描述到丝丝入扣的程度了。我们很多人看不
懂它，因为它谈的东西都不是现实，而是一个高层抽象，只有站在抽象的逻辑链上，你才
会看到它的逻辑，然后你才会注意到它推理的逻辑是什么。
...
我作为架构师，经常评审同行和下层设计的构架，我常常有这样一个评价：
...
这当然不是绝对的因果关系，但无论如何，我们的怎么都应该追求道的境界，因为那个境
界我们都是幸福的，这个家没有人“善”，没有人“孝顺”，它“无名”，正因为“无名”，所以
才是幸福。到需要有人孝顺了，这就艰难了。到有人要割块肉给父母吃，这是战略的彻底
失败，大家就只好见招拆招了，没有什么控制和管理可言了。
...
这样表示直接翻译。如果放在全文的结尾，也表示对整段翻译的补充引导。

*这样表示翻译之后对单字的和延伸意向的进一步解释*
